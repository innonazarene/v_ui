        ...
        <ul class="space-y-2 font-medium ml-6 pb-5">
            ...
            <li>
                ...
                <ul id="dropdown-employees" class="hidden py-2 space-y-2 ml-4">
                    ...
                    <li :class="checkPath('hrms-employees-201')">
                        <Nuxt-link to="/hrms/employees/201" class="flex items-center p-2 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
